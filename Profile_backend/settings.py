...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-lrbwaxez&q_!zk!xed7-*cx1d12%qwjaqshyorci3*)8$8r00v')
...
# URL configuration
ROOT_URLCONF = 'Profile_backend.urls'  # Update to match your project name
